  ...
  return (
    <div className="bg-gray-50 min-h-screen">
      <div className="max-w-7xl mx-auto ">
        {/* UI-only: standardized page header; attribute logic is unchanged. */}
        <div className="mb-8">
          <div data-page-icon data-icon-symbol="⚙" className="bg-gradient-to-r from-[#204972] to-[#87b105] rounded-xl shadow-lg mb-6 p-6 text-white">
            ...
            <p className="mt-1 opacity-90">Create and manage product attributes</p>
          </div>
        ...
        {/* UI-only: attribute table now matches GlobalTable; selection and actions are unchanged. */}
