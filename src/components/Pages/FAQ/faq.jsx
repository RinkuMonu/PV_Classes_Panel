...
// import { FaEdit, FaTrash, FaEye, FaPlus, FaTimes, FaQuestionCircle } from "react-icons/fa";
...
//               {faqs.map((faq) => (
//                 <div key={faq._id} className="border border-green-200 rounded-lg overflow-hidden hover:shadow-md transition-shadow">
...
//               </div>
//               <h3 className="text-lg font-medium text-gray-700 mb-2">No FAQs yet</h3>
