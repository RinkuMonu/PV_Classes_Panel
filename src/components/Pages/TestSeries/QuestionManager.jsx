...
import React, { useState } from 'react';
import { addQuestionsToTest, deleteQuestionFromTest } from '../../../services/testSeriesApi';
import { toast, ToastContainer } from 'react-toastify';
import 'react-toastify/dist/ReactToastify.css';
...
const QuestionManager = ({ series, test, onBack }) => {
  ...
  const handleDeleteQuestion = async (questionId) => {
    ...
    try {
      await deleteQuestionFromTest(series._id, test._id, questionId);
      ...
      <div className="bg-white rounded-xl shadow-lg overflow-hidden border border-green-100">
        ...
        <div className="divide-y divide-green-100">
          {questions.length === 0 ? (
            ...
            questions.map((question, index) => (
              <div key={question._id || index} className="p-6 hover:bg-green-50 transition-colors">
                <div className="flex justify-between items-start">
                  <div className="flex-1">
                    <div className="flex items-start">
                      <span className="flex-shrink-0 h-8 w-8 bg-green-100 text-green-800 rounded-full flex items-center justify-center font-medium mr-3">
                  ...
                  <div className="ml-4 flex flex-col items-end space-y-2">
                    ...
                    <button
                      ...
                      className="px-3 py-1 bg-red-100 text-red-700 rounded-md text-sm hover:bg-red-200 transition-colors flex items-center disabled:opacity-50 disabled:cursor-not-allowed"
                    >
