...
const TestSeriesForm = ({ series, onSubmit, onCancel }) => {
  ...
  useEffect(() => {
    ...
    if (series) {
      setFormData({
        ...
        is_free: series.is_free !== undefined ? series.is_free : true,
      });
    }
  }, [series]);
  ...
  return (
    <div className="bg-white p-6 rounded-lg shadow-lg border border-green-100">
      ...
      <h2 className="text-2xl font-bold mb-6 text-black border-b border-green-200 pb-3">
...
/>
          ...
          <div className="flex items-center p-2 bg-green-50 rounded-lg">
            <input
              ...
              onChange={handleChange}
              className="h-5 w-5 accent-[#87b105] text-white rounded "
            />
        ...
        <div className=" p-4 rounded-lg">
          ...
          <div className="flex flex-col sm:flex-row gap-2 mb-3">
            ...
            <button
              ...
              className="px-4 py-2 bg-[#87b105] text-white rounded-lg hover:scale-105 transition "
            >
              Add Subject
            </button>
          </div>
        ...
        <div className="p-4 rounded-lg">
          ...
          <div className="flex items-center gap-3 mb-2">
            <label className="flex flex-col items-center justify-center w-full h-32 border-2 border-dashed border-[#87b105] rounded-lg cursor-pointer bg-white hover:bg-[#EEF7E0] transition">
              <div className="flex flex-col items-center justify-center pt-5 pb-6">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 text-[#87b105]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div className="flex justify-end space-x-4 pt-4 border-t border-green-200">
          <button
            type="button"
            onClick={onCancel}
            className="px-5 py-2 border border-gray-300 rounded-lg text-gray-700 hover:bg-gray-50 transition focus:ring-2 focus:ring-gray-500 focus:ring-opacity-50 form-cancel-button"
          >
            Cancel
          </button>
          <button
