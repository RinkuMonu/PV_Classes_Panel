...
const TestSeriesDashboard = () => {
  ...
  return (
    <div className="container mx-auto px-4 py-4">
      ...
      {/* UI-only: standardized page header; test-series logic is unchanged. */}
      <div data-page-icon data-icon-symbol="✓" className="bg-gradient-to-r from-[#204972] to-[#87b105] rounded-xl shadow-lg mb-6 p-6 text-white">
        <h1 className="text-2xl font-bold text-white">Test Series Management</h1>
        <p className="mt-1 opacity-90">Create and manage test series for your exams</p>
      </div>
      
      <div className="bg-white rounded-lg shadow-md overflow-hidden mb-6">
        <div className="flex border-b">
          <button
            className={`py-4 px-6 font-medium flex items-center ${activeTab === 'list' ? 'border-b-2 border-[#204972] text-black bg-[#EEF4FA]' : 'text-gray-500 hover:text-gray-700 hover:bg-gray-50'}`}
            onClick={() => setActiveTab('list')}
          >
          ...
          <button
            className={`py-4 px-6 font-medium flex items-center ${activeTab === 'create' ? 'border-b-2 border-[#204972] text-black bg-[#EEF4FA]' : 'text-gray-500 hover:text-gray-700 hover:bg-gray-50'}`}
            onClick={() => setActiveTab('create')}
          >
            <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2" viewBox="0 0 20 20" fill="currentColor">
          ...
          {selectedSeries && activeTab === 'edit' && (
            <button
              className={`py-4 px-6 font-medium flex items-center border-b-2 border-[#204972] text-black bg-[#EEF4FA]`}
            >
              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2" viewBox="0 0 20 20" fill="currentColor">
