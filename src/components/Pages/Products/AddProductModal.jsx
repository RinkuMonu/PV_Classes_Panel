...
export default function AddProductModal({ isOpen, onClose, onAddProduct }) {
  ...
  return (
    <div className="fixed inset-0 bg-gray-900/20 backdrop-blur-sm flex items-center justify-end z-50 overflow-hidden" onClick={onClose}>
      <div
          ...
          <div className="flex justify-between">
            ...
            <div className="flex space-x-3">
              <button
                type="button"
                onClick={onClose}
                className="px-4 py-2 border border-gray-300 dark:border-gray-600 shadow-sm text-sm font-medium text-gray-700 dark:text-gray-300 bg-white dark:bg-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-emerald-500 rounded-lg transition-colors form-cancel-button"
              >
                Cancel
              </button>
              {currentStep < 3 ? (
